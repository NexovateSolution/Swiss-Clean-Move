...
export function generateQuoteHtml(quote: QuoteResult, customer: any, documentType: 'quote' | 'contract' | 'receipt' | 'invoice' = 'quote'): string {
  ...
  const translatedLabels: Record<string, any> = {
    ...
    deliveryHandoverDate: { de: 'Übergabetermin', en: 'Handover Date', fr: 'Date de Remise', it: `Data di consegna` },
    ...
    blinds: { de: 'Storen / Jalousien', en: 'Blinds', fr: 'Stores', it: 'Tapparelle' },
    Blinds: { de: 'Storen / Jalousien', en: 'Blinds', fr: 'Stores', it: 'Tapparelle' },
  ...
  const translatedValues: Record<string, any> = {
    ...
    twoWeekly: { de: 'Alle 2 Wochen', en: 'Every 2 Weeks', fr: 'Toutes les 2 semaines', it: 'Ogni 2 settimane' },
    threeWeekly: { de: 'Alle 3 Wochen', en: 'Every 3 Weeks', fr: 'Toutes les 3 semaines', it: 'Ogni 3 settimane' },
    fourWeekly: { de: 'Alle 4 Wochen', en: 'Every 4 Weeks', fr: 'Toutes les 4 semaines', it: 'Ogni 4 settimane' },
    oneTime: { de: 'Einmalig', en: 'One-Time', fr: 'Unique', it: 'Una volta' },
    ...
    office: { de: 'Büro', en: 'Office', fr: 'Bureau', it: `Ufficio` },
    officeBuilding: { de: 'Bürogebäude', en: 'Office Building', fr: 'Immeuble de Bureaux', it: 'Edificio per Uffici' },
    ...
    // Cleaning types
    movingOutCleaning: { de: 'Umzugsreinigung', en: 'Move-out Cleaning', fr: 'Nettoyage de fin de bail', it: 'Pulizia di trasloco' },
    ...
    officeCleaning: { de: 'Büroreinigung', en: 'Office Cleaning', fr: 'Nettoyage de bureau', it: 'Pulizia uffici' },
    restaurantCleaning: { de: 'Gastronomiereinigung', en: 'Restaurant Cleaning', fr: 'Nettoyage de restaurant', it: 'Pulizia ristoranti' },
    windowCleaning: { de: 'Fensterreinigung', en: 'Window Cleaning', fr: 'Nettoyage de vitres', it: 'Pulizia vetri' },
    caretaking: { de: 'Hauswartung', en: 'Caretaking', fr: 'Conciergerie', it: 'Manutenzione' },
    stairwellCleaning: { de: 'Treppenhausreinigung', en: 'Stairwell Cleaning', fr: 'Nettoyage des escaliers', it: 'Pulizia delle scale' },
    specialistCleaning: { de: 'Spezialreinigung', en: 'Specialist Cleaning', fr: 'Nettoyage spécialisé', it: 'Pulizia specializzata' },
    // Outdoor area
      ...
      <div class="contact-info">
        ...
        <table style="border-spacing: 0;">
          <tr>
            ...
            <td style="padding-bottom: 5px;">Orpundstrasse 37<br>2504 Biel/Bienne</td>
          </tr>
          <tr>
      ...
      <div class="contact-info">
        <table style="border-spacing: 0;">
          <tr>
            ...
            <td>Orpundstrasse 37<br>2504 Biel/Bienne</td>
          </tr>
          <tr>
