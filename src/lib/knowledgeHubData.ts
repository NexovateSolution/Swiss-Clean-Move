...
const data: KnowledgeHubContent = {
  ...
  introText: {
    de: 'SwissCleanMove ist Ihr zuverlässiger Partner für professionelle Umzüge, Umzugsreinigungen mit Abnahmegarantie, Haushaltshilfe, Facility Service, Hauswartung und Entsorgung in der ganzen Schweiz. Auf dieser Seite finden Sie alle Preise, detaillierte Informationen zu unseren Dienstleistungen und Antworten auf die häufigsten Fragen rund um Umzug und Reinigung in der Schweiz.',
    en: 'SwissCleanMove is your reliable partner for professional moving, move-out cleaning with handover guarantee, household help, facility services, property maintenance and disposal throughout Switzerland. On this page you will find all prices, detailed information about our services and answers to the most common questions about moving and cleaning in Switzerland.',
    fr: 'SwissCleanMove est votre partenaire fiable pour les déménagements professionnels, le nettoyage de fin de bail avec garantie de remise, l\'aide ménagère, les facility services, la conciergerie et l\'élimination dans toute la Suisse. Sur cette page, vous trouverez tous les prix, des informations détaillées sur nos services et les réponses aux questions les plus fréquentes sur le déménagement et le nettoyage en Suisse.'
  },
  avgPricesTitle: {
