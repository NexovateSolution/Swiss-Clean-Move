...
const data: KnowledgeHubContent = {
  ...
  introText: {
    de: 'SwissCleanMove ist Ihr vertrauensvoller Partner für Premium-Umzüge, Umzugsreinigungen mit 100% Abnahmegarantie, Haushaltshilfe, Facility Service und umfassende Entsorgungsdienste in der gesamten Schweiz. Hier finden Sie transparente Preise, detaillierte Leistungsübersichten und kompetente Antworten auf Ihre wichtigsten Fragen rund um Umzug und Reinigung in der Schweiz.',
    en: 'SwissCleanMove is your trusted partner for premium moving services, move-out cleaning with a 100% handover guarantee, household help, facility service, and comprehensive disposal services across Switzerland. Here, you will find transparent pricing, detailed service overviews, and expert answers to your most pressing questions about moving and cleaning in Switzerland.',
    fr: 'SwissCleanMove est votre partenaire de confiance pour des services de déménagement premium, le nettoyage de fin de bail avec garantie de remise à 100 %, l\'aide ménagère, le facility service et des services d\'élimination complets dans toute la Suisse. Vous y trouverez des prix transparents, des aperçus détaillés de nos services et des réponses d\'experts à vos questions les plus importantes sur le déménagement et le nettoyage en Suisse.'
  },
  avgPricesTitle: {
  ...
  avgPricesFactors: [
    {
      ...
      desc: { de: 'Schweizer Durchschnitt: CHF 1\'200 – CHF 3\'500. SwissCleanMove: ab CHF 1\'190.– inkl. Transportversicherung, professionellem Team und Verpackungsmaterial.', en: 'Swiss average: CHF 1,200 – CHF 3,500. SwissCleanMove: from CHF 1,190.– incl. transport insurance, professional team and packing materials.', fr: 'Moyenne suisse : CHF 1\'200 – CHF 3\'500. SwissCleanMove : dès CHF 1\'190.– incl. assurance transport, équipe professionnelle et matériel d\'emballage.' }
    },
    {
      label: { de: 'Umzugsreinigung (3.5-Zimmer-Wohnung)', en: 'Move-out cleaning (3.5-room apt)', fr: 'Nettoyage fin de bail (3.5 pièces)' },
      desc: { de: 'Schweizer Durchschnitt: CHF 800 – CHF 1\'500. SwissCleanMove: ab CHF 890.– mit 100% Abnahmegarantie und kostenloser Nachreinigung.', en: 'Swiss average: CHF 800 – CHF 1,500. SwissCleanMove: from CHF 890.– with 100% handover guarantee and free re-cleaning.', fr: 'Moyenne suisse : CHF 800 – CHF 1\'500. SwissCleanMove : dès CHF 890.– avec garantie de remise à 100% et nettoyage ultérieur gratuit.' }
    },
    {
      label: { de: 'Haushaltshilfe', en: 'Household help', fr: 'Aide ménagère' },
      desc: { de: 'Schweizer Durchschnitt: CHF 35 – CHF 55 / Stunde. SwissCleanMove: ab CHF 42.– / Stunde für regelmässige Einsätze. Versichert, professionell und zuverlässig.', en: 'Swiss average: CHF 35 – CHF 55 / hour. SwissCleanMove: from CHF 42.– / hour for regular appointments. Insured, professional and reliable.', fr: 'Moyenne suisse : CHF 35 – CHF 55 / heure. SwissCleanMove : dès CHF 42.– / heure pour les interventions régulières. Assuré, professionnel et fiable.' }
    },
    {
      label: { de: 'Entsorgung & Räumung', en: 'Disposal & clearance', fr: 'Élimination & débarras' },
      desc: { de: 'Schweizer Durchschnitt: CHF 500 – CHF 3\'000 (Wohnungsräumung). SwissCleanMove: ab CHF 690.– inkl. fachgerechter Entsorgung und Recycling.', en: 'Swiss average: CHF 500 – CHF 3,000 (apartment clearance). SwissCleanMove: from CHF 690.– incl. professional disposal and recycling.', fr: 'Moyenne suisse : CHF 500 – CHF 3\'000 (débarras d\'appartement). SwissCleanMove : dès CHF 690.– incl. élimination professionnelle et recyclage.' }
    }
  ],
  avgPricesNote: {
  ...
  facilityCards: [
    ...
    },
    {
      ...
      price: { de: 'Ab CHF 35.– / Stunde', en: 'From CHF 35.– / hour', fr: 'Dès CHF 35.– / heure' }
    },
    {
    ...
    },
    {
      ...
      price: { de: 'Ab CHF 45.– / Stunde', en: 'From CHF 45.– / hour', fr: 'Dès CHF 45.– / heure' }
    }
  ],
  comparisons: {
    ...
    items: [
      {
        ...
        right: {
          ...
          price: { de: 'Ab CHF 490.–', en: 'From CHF 490.–', fr: 'Dès CHF 490.–' }
        }
      },
      {
        ...
        left: {
          ...
          price: { de: 'Ab CHF 42.– / Stunde', en: 'From CHF 42.– / hour', fr: 'Dès CHF 42.– / heure' }
        },
        right: {
          title: { de: 'Unterhaltsreinigung', en: 'Maintenance Cleaning', fr: 'Nettoyage d\'entretien' },
          points: [
      ...
      },
      {
        ...
        right: {
          ...
          price: { de: 'Ab CHF 490.– (alles inklusive)', en: 'From CHF 490.– (everything included)', fr: 'Dès CHF 490.– (tout inclus)' }
        }
      },
      {
        ...
        left: {
          ...
          points: [
            { de: 'Ganzheitlicher Gebäudeservice', en: 'Holistic building service', fr: 'Service global de bâtiment' },
        ...
        right: {
          ...
          price: { de: 'Ab CHF 500.– / Monat', en: 'From CHF 500.– / month', fr: 'Dès CHF 500.– / mois' }
        }
      }
    ]
  },
      ...
      questions: [
        {
          ...
          snippet: { de: 'Ein professioneller Umzug in der Schweiz kostet je nach Wohnungsgrösse zwischen CHF 490.– und CHF 2\'490.–. Die Preise hängen von Zimmerzahl, Stockwerk, Distanz und Möbelmenge ab.', en: 'A professional move in Switzerland costs between CHF 490 and CHF 2,490 depending on apartment size. Prices depend on number of rooms, floor level, distance and quantity of furniture.', fr: 'Un déménagement professionnel en Suisse coûte entre CHF 490.– et CHF 2\'490.– selon la taille de l\'appartement. Les prix dépendent du nombre de pièces, de l\'étage, de la distance et de la quantité de meubles.' },
          answer: { de: 'Bei SwissCleanMove beginnen die Umzugspreise bei CHF 490.– für eine 1-Zimmer-Wohnung. Eine 3.5-Zimmer-Wohnung kostet ab CHF 1\'190.–, ein Einfamilienhaus ab CHF 2\'490.–. Im Preis inbegriffen sind ein professionelles Umzugsteam, modernes Transportfahrzeug, Transportversicherung, Möbelschutz, Verpackungsmaterial sowie Be- und Entladen. Zusätzliche Faktoren wie Stockwerk ohne Lift, besonders schwere Gegenstände oder sehr lange Distanzen können den Preis beeinflussen. SwissCleanMove erstellt Ihnen eine kostenlose und unverbindliche Festpreisofferte nach einer persönlichen Besichtigung oder auf Basis Ihrer Angaben.', en: 'At SwissCleanMove, moving prices start at CHF 490 for a 1-room apartment. A 3.5-room apartment costs from CHF 1,190, a single-family house from CHF 2,490. The price includes a professional moving team, modern transport vehicle, transport insurance, furniture protection, packing materials and loading/unloading. Additional factors such as floor without elevator, particularly heavy items or very long distances may affect the price. SwissCleanMove provides you with a free and non-binding fixed-price quote after a personal inspection or based on your details.', fr: 'Chez SwissCleanMove, les prix de déménagement commencent à CHF 490.– pour un appartement 1 pièce. Un appartement 3.5 pièces coûte dès CHF 1\'190.–, une maison individuelle dès CHF 2\'490.–. Le prix comprend une équipe professionnelle, un véhicule de transport moderne, une assurance transport, la protection des meubles, le matériel d\'emballage et le chargement/déchargement. Des facteurs supplémentaires comme l\'étage sans ascenseur, des objets particulièrement lourds ou de très longues distances peuvent influencer le prix. SwissCleanMove vous fournit un devis à prix fixe gratuit et sans engagement.' },
      ...
      questions: [
        {
          ...
          snippet: { de: 'Eine professionelle Umzugsreinigung mit Abnahmegarantie kostet in der Schweiz zwischen CHF 490.– (Studio) und CHF 1\'390.– (5-Zimmer-Wohnung). Bei SwissCleanMove ist die kostenlose Nachreinigung bei Beanstandungen im Preis inbegriffen.', en: 'A professional move-out cleaning with handover guarantee costs between CHF 490 (studio) and CHF 1,390 (5-room apartment) in Switzerland. At SwissCleanMove, free re-cleaning in case of complaints is included.', fr: 'Un nettoyage de fin de bail professionnel avec garantie de remise coûte entre CHF 490.– (studio) et CHF 1\'390.– (5 pièces) en Suisse. Chez SwissCleanMove, le nettoyage ultérieur gratuit en cas de réclamation est inclus.' },
          answer: { de: 'Die Umzugsreinigung ist eine der wichtigsten Dienstleistungen beim Wohnungswechsel. Bei SwissCleanMove beginnen die Preise bei CHF 490.– für ein Studio und reichen bis CHF 1\'390.– für eine 5-Zimmer-Wohnung. Häuser und Villen werden individuell kalkuliert. Im Preis inbegriffen sind: Fensterreinigung innen und aussen, Reinigung aller Storen, komplette Küchenreinigung inkl. Backofen und Kühlschrank, Entkalkung von Bad und Sanitäranlagen, Boden- und Oberflächenreinigung sowie die 100% Abnahmegarantie. Das bedeutet: Sollte die Verwaltung bei der Abnahme Mängel feststellen, kommt SwissCleanMove kostenlos für eine Nachreinigung zurück. Dieses Versprechen gibt Ihnen volle Sicherheit für eine erfolgreiche Wohnungsübergabe.', en: 'Move-out cleaning is one of the most important services when changing apartments. At SwissCleanMove, prices start at CHF 490 for a studio and go up to CHF 1,390 for a 5-room apartment. Houses and villas are calculated individually. Included in the price: interior and exterior window cleaning, cleaning of all blinds, complete kitchen cleaning incl. oven and fridge, descaling of bathroom and sanitary facilities, floor and surface cleaning and the 100% handover guarantee. This means: if the management identifies defects during the inspection, SwissCleanMove returns for a free re-cleaning. This promise gives you full security for a successful property handover.', fr: 'Le nettoyage de fin de bail est l\'un des services les plus importants lors d\'un changement d\'appartement. Chez SwissCleanMove, les prix commencent à CHF 490.– pour un studio et vont jusqu\'à CHF 1\'390.– pour un 5 pièces. Maisons et villas sont calculées individuellement. Inclus dans le prix : nettoyage des vitres intérieur et extérieur, nettoyage de tous les stores, nettoyage complet de la cuisine incl. four et réfrigérateur, détartrage de la salle de bain et sanitaires, nettoyage des sols et surfaces et la garantie de remise à 100%. Cela signifie : si la gérance constate des défauts lors de la remise, SwissCleanMove revient gratuitement pour un nettoyage ultérieur.' },
      ...
      questions: [
        {
          ...
          snippet: { de: 'Eine professionelle Haushaltshilfe kostet bei SwissCleanMove ab CHF 42.– pro Stunde bei wöchentlichen Einsätzen. Einmalige Einsätze beginnen ab CHF 48.– pro Stunde. Mindestauftrag: CHF 120.–.', en: 'A professional household helper costs from CHF 42 per hour for weekly appointments at SwissCleanMove. One-time appointments start from CHF 48 per hour. Minimum order: CHF 120.', fr: 'Une aide ménagère professionnelle coûte dès CHF 42.– par heure pour les interventions hebdomadaires chez SwissCleanMove. Les interventions ponctuelles commencent à CHF 48.– par heure. Commande minimum : CHF 120.–.' },
          answer: { de: 'SwissCleanMove bietet professionelle Haushaltshilfe für Privathaushalte, Familien, Senioren und Berufstätige. Bei regelmässigen wöchentlichen Einsätzen liegt der Preis bei CHF 42.– pro Stunde. Haushaltshilfe im 14-tägigen Rhythmus kostet CHF 45.– pro Stunde, einmalige Einsätze CHF 48.– pro Stunde. Unsere Premium Haushaltshilfe (CHF 49.– / Stunde) bietet zusätzliche Leistungen wie Grundreinigung und spezielle Wünsche. Im Service enthalten sind Staubsaugen, Bodenreinigung, Küchen- und Badreinigung, Abstauben, Betten beziehen, Wäsche waschen und auf Wunsch Bügelservice. Alle unsere Haushaltshilfen sind versichert, geschult und arbeiten nach Schweizer Qualitätsstandards. Der Mindestauftrag beträgt CHF 120.–.', en: 'SwissCleanMove offers professional household help for private households, families, seniors and busy professionals. For regular weekly appointments, the price is CHF 42 per hour. Household help every two weeks costs CHF 45 per hour, one-time appointments CHF 48 per hour. Our premium household help (CHF 49 / hour) offers additional services like deep cleaning and special requests. Services include vacuuming, floor cleaning, kitchen and bathroom cleaning, dusting, bed making, laundry washing and ironing on request. All our household helpers are insured, trained and work according to Swiss quality standards. Minimum order is CHF 120.', fr: 'SwissCleanMove propose une aide ménagère professionnelle pour les ménages privés, familles, personnes âgées et professionnels. Pour les interventions hebdomadaires régulières, le prix est de CHF 42.– par heure. L\'aide ménagère toutes les deux semaines coûte CHF 45.– par heure, les interventions ponctuelles CHF 48.– par heure. Notre aide ménagère premium (CHF 49.– / heure) offre des prestations supplémentaires. Les services incluent l\'aspirateur, nettoyage des sols, cuisine et salle de bain, dépoussiérage, lits, lessive et repassage sur demande. Toutes nos aides ménagères sont assurées, formées et travaillent selon les standards suisses. Commande minimum : CHF 120.–.' },
      ...
      questions: [
        {
          ...
          snippet: { de: 'Facility Service wird individuell kalkuliert und richtet sich nach Objektgrösse, Leistungsumfang und Einsatzhäufigkeit. Unterhaltsreinigung beginnt ab CHF 35.– / Stunde, umfassende Hauswartung ab CHF 500.– / Monat.', en: 'Facility service is individually calculated based on property size, scope of services and frequency. Maintenance cleaning starts from CHF 35 / hour, comprehensive property maintenance from CHF 500 / month.', fr: 'Le facility service est calculé individuellement selon la taille de la propriété, l\'étendue des services et la fréquence. Le nettoyage d\'entretien commence dès CHF 35.– / heure, la conciergerie complète dès CHF 500.– / mois.' },
          answer: { de: 'Der Facility Service von SwissCleanMove umfasst einen ganzheitlichen Gebäudeservice: Reinigung, Hauswartung, Aussenunterhalt, Winterdienst, Grünpflege und technische Betreuung. Die Kosten werden individuell auf Basis von Objektgrösse, gewünschtem Leistungsumfang und Einsatzhäufigkeit berechnet. Für die reine Unterhaltsreinigung (Treppenhäuser, Gemeinschaftsräume) beginnen die Preise ab CHF 35.– pro Stunde. Umfassende Hauswartungspakete mit regelmässiger Gebäudebetreuung starten ab CHF 500.– pro Monat. SwissCleanMove betreut Verwaltungen, Gewerbebetriebe und Liegenschaftsbesitzer in der ganzen Schweiz und erstellt massgeschneiderte Serviceverträge.', en: 'SwissCleanMove\'s facility service includes holistic building service: cleaning, property maintenance, exterior upkeep, winter service, green care and technical support. Costs are individually calculated based on property size, desired scope of services and frequency. For maintenance cleaning only (stairwells, common areas), prices start from CHF 35 per hour. Comprehensive property maintenance packages with regular building care start from CHF 500 per month. SwissCleanMove serves property managers, businesses and property owners throughout Switzerland with tailored service contracts.', fr: 'Le facility service de SwissCleanMove comprend un service global de bâtiment : nettoyage, conciergerie, entretien extérieur, service hivernal, entretien des espaces verts et support technique. Les coûts sont calculés individuellement selon la taille de la propriété, l\'étendue souhaitée des services et la fréquence. Pour le nettoyage d\'entretien seul (cages d\'escalier, espaces communs), les prix commencent dès CHF 35.– par heure. Les forfaits de conciergerie complets avec entretien régulier commencent dès CHF 500.– par mois.' },
      ...
      questions: [
        {
          ...
          snippet: { de: 'Eine professionelle Wohnungsräumung kostet bei SwissCleanMove ab CHF 690.–. Kleinere Entsorgungen beginnen ab CHF 150.–, Hausräumungen ab CHF 1\'490.–.', en: 'Professional apartment clearance costs from CHF 690 at SwissCleanMove. Smaller disposals start from CHF 150, house clearances from CHF 1,490.', fr: 'Un débarras d\'appartement professionnel coûte dès CHF 690.– chez SwissCleanMove. Les petites éliminations commencent dès CHF 150.–, les débarras de maison dès CHF 1\'490.–.' },
          answer: { de: 'SwissCleanMove bietet professionelle Entsorgung und Räumung in der ganzen Schweiz. Eine vollständige Wohnungsräumung kostet ab CHF 690.– und umfasst das Ausräumen aller Möbel, Gegenstände und Abfall, die fachgerechte Entsorgung nach Schweizer Standards, Recycling wiederverwertbarer Materialien, Verladung und Abtransport sowie eine besenreine Übergabe. Für kleinere Entsorgungen (ab CHF 150.–) und Keller- oder Estrichräumungen (ab CHF 300.–) bieten wir ebenfalls flexible Lösungen. Hausräumungen und Geschäftsauflösungen werden individuell kalkuliert. Alle Entsorgungen erfolgen umweltgerecht und nach den geltenden Vorschriften.', en: 'SwissCleanMove offers professional disposal and clearance throughout Switzerland. A complete apartment clearance costs from CHF 690 and includes clearing all furniture, items and waste, professional disposal according to Swiss standards, recycling of reusable materials, loading and transport and a swept-clean handover. For smaller disposals (from CHF 150) and basement or attic clearances (from CHF 300), we also offer flexible solutions. House clearances and business liquidations are calculated individually. All disposals are carried out in an environmentally friendly manner and according to applicable regulations.', fr: 'SwissCleanMove propose l\'élimination et le débarras professionnels dans toute la Suisse. Un débarras d\'appartement complet coûte dès CHF 690.– et comprend le vidage de tous les meubles, objets et déchets, l\'élimination professionnelle selon les normes suisses, le recyclage des matériaux réutilisables, le chargement et transport et une remise balayée. Pour les petites éliminations (dès CHF 150.–) et les débarras de cave ou grenier (dès CHF 300.–), nous proposons également des solutions flexibles.' },
