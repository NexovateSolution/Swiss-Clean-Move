...
const data: KnowledgeHubContent = {
  meta: {
    title: {
      ...
      fr: 'Prix & Conseils - D̩m̩nagement, Nettoyage, Aide M̩nag̬re Suisse | SwissCleanMove'
    },
    description: {
  ...
  facilityCards: [
    {
      ...
      price: { de: 'Auf Anfrage - individuell kalkuliert', en: 'Upon request - individually calculated', fr: 'Sur demande - calcul̩ individuellement' }
    },
    {
      ...
      price: { de: `Ab CHF ${PRICING_RULES.maintenance.hourlyRates.residential}.- / Stunde`, en: `From CHF ${PRICING_RULES.maintenance.hourlyRates.residential}.- / hour`, fr: `D̬s CHF ${PRICING_RULES.maintenance.hourlyRates.residential}.- / heure` }
    },
    {
    ...
    },
    {
      ...
      price: { de: `Ab CHF ${PRICING_RULES.cleaning.house['3.5']}.- / Stunde`, en: `From CHF ${PRICING_RULES.cleaning.house['3.5']}.- / hour`, fr: `D̬s CHF ${PRICING_RULES.cleaning.house['3.5']}.- / heure` }
    }
  ],
  comparisons: {
    ...
    items: [
      {
        ...
        left: {
          ...
          price: { de: 'Ab CHF 400.-', en: 'From CHF 400.-', fr: 'D̬s CHF 400.-' }
        },
        right: {
          ...
          price: { de: `Ab CHF ${PRICING_RULES.moving.baseRates['1']}.-`, en: `From CHF ${PRICING_RULES.moving.baseRates['1']}.-`, fr: `D̬s CHF ${PRICING_RULES.moving.baseRates['1']}.-` }
        }
      },
      {
        ...
        left: {
          ...
          price: { de: `Ab CHF ${PRICING_RULES.household.regular}.- / Stunde`, en: `From CHF ${PRICING_RULES.household.regular}.- / hour`, fr: `D̬s CHF ${PRICING_RULES.household.regular}.- / heure` }
        },
        right: {
          title: { de: 'Unterhaltsreinigung', en: 'Maintenance Cleaning', fr: 'Nettoyage d\'entretien' },
          points: [
      ...
      },
      {
        ...
        left: {
          ...
          points: [
            { de: 'Transporter selbst mieten (CHF 150-300/Tag)', en: 'Rent van yourself (CHF 150-300/day)', fr: 'Louer un utilitaire soi-m̻me (CHF 150-300/jour)' },
            ...
            { de: 'Zeitaufwand: 1-3 Tage', en: 'Time: 1-3 days', fr: 'Dur̩e : 1-3 jours' },
          ],
        ...
        right: {
          ...
          price: { de: `Ab CHF ${PRICING_RULES.moving.baseRates['1']}.- (alles inklusive)`, en: `From CHF ${PRICING_RULES.moving.baseRates['1']}.- (everything included)`, fr: `D̬s CHF ${PRICING_RULES.moving.baseRates['1']}.- (tout inclus)` }
        }
      },
      {
        ...
        right: {
          ...
          price: { de: `Ab CHF ${PRICING_RULES.facilityService.monthly['500']}.- / Monat`, en: `From CHF ${PRICING_RULES.facilityService.monthly['500']}.- / month`, fr: `D̬s CHF ${PRICING_RULES.facilityService.monthly['500']}.- / mois` }
        }
      }
    ]
  },
  preparation: {
    title: { de: 'Umzugsvorbereitung - Ihre Checkliste', en: 'Moving Preparation - Your Checklist', fr: 'Pr̩paration au D̩m̩nagement - Votre Checklist' },
