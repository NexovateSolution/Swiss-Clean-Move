...
//             units: { en: 'Units', de: 'Einheiten', fr: 'Unités' },
            ...
            cleanStreet: { en: 'Street (Cleaning)', de: 'Strasse (Reinigung)', fr: 'Rue (Nettoyage)' },
            cleanZipCity: { en: 'ZIP/City (Cleaning)', de: 'PLZ/Ort (Reinigung)', fr: 'NPA/Lieu (Nettoyage)' },
            ...
            cleanShuttersBlinds: { en: 'Clean Shutters/Blinds', de: 'Storen/Rollläden reinigen', fr: 'Nettoyer les stores/volets' },
...
export const valLabels: Record<string, Record<string, string>> = {
            ...
            whatsapp: { en: 'WhatsApp', de: 'WhatsApp', fr: 'WhatsApp' },
            ...
            tableChairs: { en: 'Table & Chairs', de: 'Tisch & Stühle', fr: 'Table & Chaises' },
            bed: { en: 'Bed', de: 'Bett', fr: 'Lit' },
            washingMachine: { en: 'Washing Machine', de: 'Waschmaschine', fr: 'Lave-linge' },
