      ...
      <div className="bg-gray-50 min-h-screen pb-16 pt-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Google Reviews Card */}
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center space-y-4">
              <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-gray-100 shadow-sm flex items-center justify-center bg-white">
                <img src="/images/logo.png" alt="SwissCleanMove" className="w-full h-full object-contain" />
              </div>
              <div>
                <h3 className="font-bold text-[#001f3f] text-lg">SwissCleanMove</h3>
                <div className="flex items-center justify-center space-x-1 mt-1">
                  <span className="text-lg font-bold text-[#e7711b]">4.4</span>
                  <div className="flex space-x-0.5">
                    {[...Array(4)].map((_, i) => (
                      <StarIcon key={i} className="w-5 h-5 text-[#e7711b] fill-current" />
                    ))}
                    <StarIcon className="w-5 h-5 text-[#e7711b]" style={{ clipPath: 'inset(0 50% 0 0)' }} />
                  </div>
                </div>
              ...
              <a
                ...
                className="inline-flex items-center space-x-2 bg-white border-2 border-gray-100 rounded-full px-5 py-2.5 text-sm font-semibold text-[#001f3f] hover:shadow-md hover:border-blue-300 transition-all"
              >
