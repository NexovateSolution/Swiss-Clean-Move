...
export default function StairwellCleaningPage({ params: { locale } }: { params: { locale: string } }) {
  ...
  const features = (t.raw('services.features.stairwellCleaning') as string[]) || [];
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <SwissHero
        badge={t('home.services.stairwellCleaning.title')}
        title={t('home.services.stairwellCleaning.title')}
        subtitle={t('home.services.stairwellCleaning.description')}
        cta={
          <div className="flex flex-col sm:flex-row gap-4 justify-start">
            <Link href={`/${locale}/form?service=stairwell-cleaning`} className="btn-secondary text-lg px-8 py-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-swiss-gray-800">
                {t('home.services.stairwellCleaning.title')}
              </h2>
              <p className="text-lg text-swiss-gray-700">
                {t('home.services.stairwellCleaning.description')}
              </p>
              ...
              <div className="bg-swiss-blue/10 p-6 rounded-lg">
                <div className="text-2xl font-bold text-swiss-blue mb-2">{t('services.pricing.stairwellCleaning')}</div>
              </div>
            </div>
            <div className="relative">
              <div className="bg-swiss-gray-200 rounded-2xl h-96 flex items-center justify-center">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-swiss-gray-600">{t('home.services.stairwellCleaning.title')}</p>
                </div>
              </div>
            </div>
          </div>
