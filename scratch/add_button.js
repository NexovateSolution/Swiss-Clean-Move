...
const targetSection = `              <p className="text-sm font-medium text-gray-600">{tNew('reviews.count')}</p>
            </div>`;

const newSection = `              <p className="text-sm font-medium text-gray-600 mb-4">{tNew('reviews.count')}</p>
              <a 
